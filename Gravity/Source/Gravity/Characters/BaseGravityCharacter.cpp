...
void ABaseGravityCharacter::RotateToGravity(const FInputActionValue& ActionValue)
{
	...
	{
		// MOST OF THE ORIENTATIONS TO DIFFERENT GRAVITY VECTORS WORK UNLESS CHARACTER ALREADY HAS A CHANGE IN ROTATION. ALSO SOME GRAVITY VECTORS STILL DONT GET ORIENTED 100% CORRECTLY NO MATTER WHAT////
		// IN ENOUGH OF A WORKING STATE TO MOVE ONTO OTHER PROBLEMS ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	DrawDebugLine(GetWorld(), GetActorLocation(), GetActorLocation() + (-GravityV.GetSafeNormal() * 100.f), FColor::Blue);
